    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 pb-16 px-6">
      <div className="container max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-medium text-slate-700 dark:text-slate-400 transition-colors duration-500">
            {mockData.title}
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-xl mx-auto md:mx-0 leading-relaxed transition-colors duration-500">
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-4 -left-4 w-32 md:w-48 h-32 md:h-48 bg-primary/40 rounded-full blur-2xl"></div>
            <div className="absolute -bottom-4 -right-4 w-32 md:w-48 h-32 md:h-48 bg-indigo-500/40 rounded-full blur-2xl"></div>
